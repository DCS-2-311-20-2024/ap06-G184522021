...
function init() {
  ...
  window.addEventListener("resize", ()=>{
    ...
    cssRenderer.setSize( 0.7*window.innerWidth, 0.5*window.innerHeight-nameHeight );
    renderer.setSize( 0.7*window.innerWidth, 0.5*window.innerHeight-nameHeight );
    renderer2.setSize( 0.3*window.innerWidth, 0.6*window.innerHeight-nameHeight );
  }, false);
